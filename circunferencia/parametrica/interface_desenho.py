from circulo_parametrico import circulo_parametrico
import pygame
    ...
    def __init__(self) -> None:
        ...
        while True:
            ...
            if desenhando is True:
                ...
                circulo_parametrico(self.janela, (0,255,0), posicao_inicial, posicao_atual)            
            ...
            for i in range(len(pontos)):
                circulo_parametrico(self.janela, (0,0,0), pontos[i][0], pontos[i][1])
